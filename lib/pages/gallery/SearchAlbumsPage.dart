    ...
    return Scaffold(
      appBar: AppBar(
        title: TextField(
          ...
          focusNode: _fnSearch,
          autofocus: true,
          onChanged: (newString) => BlocProvider.of<TimelineBloc>(context).add(TimelineAlbumSearchTextChangeEvent(newString)),
  ...
  Widget _buildBody(){
    return BlocBuilder<TimelineBloc, TimelineState>(
      ...
      builder: (_,state){
        ...
        BlocProvider.of<TimelineBloc>(context).add(TimelineAlbumSearchTextChangeEvent(''));
      ...
      children: [
        Expanded(
          child: GestureDetector(
            onTap: (){
              BlocProvider.of<AppBloc>(context).add(AppToViewPostAlbumEvent(post));
            },
            child: Hero(
